#ifndef LAB_03_MODEL_COMMANDS_H
#define LAB_03_MODEL_COMMANDS_H
...
public:
    explicit LoadModelCommand(Action a, const std::string &fname_) : act(a) {
        fname = fname_;
    }
